...
const plans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "50 simulator trades per day" },
      { text: "All 25+ markets covered" },
      { text: "30-second data refresh" },
      ...
      { text: "Auto-fill SL/TP with regime-aware R:R" },
      { text: "Price alerts via email" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Unlimited simulator trades" },
      { text: "All 25+ markets covered" },
      { text: "15-second data refresh" },
      { text: "Triple-AI consensus engine" },
      { text: "AI Market Research — daily top opportunities" },
      { text: "Upload charts for AI pattern recognition" },
      { text: "Auto-fill SL/TP with regime-aware R:R" },
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                a: "Free refreshes every 60 seconds. Pro gets 30-second refresh, Premium gets 15-second refresh. Faster data means faster decisions.",
              },
              {
